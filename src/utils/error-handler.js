...
class ErrorHandler {
  ...
  static getErrorMessage(code) {
    const messages = {
      [ERROR_CODES.PRIVATE_FRIENDS_LIST]:
        "Your friends list is private. Please make it public in your Steam privacy settings.",
      [ERROR_CODES.EMPTY_FRIENDS_LIST]:
        "No friends found in your friends list.",
      [ERROR_CODES.API_ERROR_403]:
        "Access forbidden. Please check your API key permissions.",
      [ERROR_CODES.API_ERROR_401]:
        "Unauthorized. Please check your API key or token.",
    };
  ...
  static isPrivacyError(error) {
    ...
    return (
      errorCode === ERROR_CODES.PRIVATE_FRIENDS_LIST ||
