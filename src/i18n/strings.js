// Centralized UI strings (default: English)
...
export const STRINGS = {
  ...
  index: {
    ...
    updateHint: "Click \"Update Friends List\" to load your friends and start auto-refresh",
  ...
  notifications: {
    ...
    privacy: {
      warningMain: "No friends list returned. This could be because your friends list is set to private.",
      linkText: "Open your Steam privacy settings",
      linkTitle: "Open privacy settings in Steam",
      note: "After setting your friends list to public, click \"Update Friend List\", then you can set it back to private.",
    },
    cs2Launch: {
      initial: {
  ...
  help: {
    steamId: {
      ...
      option1Body: "Your profile will open in the Steam client. Click on the URL in the address bar at the top of the Steam window - this automatically copies it to your clipboard. Then paste it into the <strong>SteamID64</strong> field below.",
      ...
      option2Body: "If you already know your <strong>SteamID64</strong> (17-digit number), you can enter it directly.",
      note: "Your SteamID64 used to identify your account in Steam Web API requests.",
    },
    apiKey: {
      ...
      option1Body: "On the opened page (may appear blank / black), press <strong>Ctrl+A</strong> then <strong>Ctrl+C</strong> to copy, and <strong>Ctrl+V</strong> to paste into the Token field.",
      ...
      option2Body1: "Register a new API key by entering <strong>localhost</strong> as your domain, accept the terms, and copy your key.",
      option2Body2: "Click the <strong>SteamID64</strong> field label below to open your Steam profile, then copy your profile URL and paste it into the SteamID64 field.",
      ...
      option2Bullet3: "Make it public again temporarily to update your friends list",
      note1: "Your credentials are stored locally only.",
      note2: "All requests are made only through the official Steam Web API.",
    },
  },
  ...
  tutorial: {
    ...
    step1Content: "Quick tutorial on main features.<br>Use buttons below to navigate.",
    keyHint: "Press Enter for next step, Backspace for previous, Esc to skip.",
    step2Title: "Steam Web API Token / Key",
    step2Content: "Click the highlighted text to open help with Steam link for token.",
    step3Title: "Get Steam Web API Token",
    step3Content: "Click highlighted text to open Steam.<br>It may appear black - press Ctrl+A then Ctrl+C to copy token.",
    step4Title: "Paste Token",
    step4Content: "Paste token (Ctrl+V) into highlighted field.<br>Token expires in 24 hours, get new one when needed.",
    step5Title: "Update Friends List",
    step5Content: "Click highlighted button to load friends from Steam with game status.",
    ...
    step7Content: "Friends currently playing Casual or Deathmatch modes will appear in this list.",
    step8Title: "Join to Friend Game",
    step8Content: "For example, your best friend <strong>Gabe Newell</strong> is playing Casual on Dust 2.<br>Click 'Join' to automatically connect to his match!",
    step9Title: "Connection Process",
    step9ContentTop: "Red dot = no slots available, Yellow = attempting to connect, Green = successfully connected.",
    step9ContentNote1: "Yellow may stay for a while.",
    step9ContentNote2: "Will change to red or green once server responds.",
    step9ContentNote3: "Meanwhile, CS2 will show connection error dialogs (this is normal) - hold ESC to dismiss them all.",
    step10Title: "Tutorial Complete!",
    step10ContentTop: "Congratulations! You've completed the tutorial and learned all the main features.<br><br>Enjoy using Casual Enjoyer!",
