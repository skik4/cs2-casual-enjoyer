...
class SteamAPIClient {
    ...
    static async getPlayerSummaries(steamids, auth) {
        ...
        try {
            ...
            for (let i = 0; i < steamids.length; i += 100) {
                ...
                const data = await this._makeRequest('GetPlayerSummaries', params, auth, {
                    allowFailure: true,
            ...
            SteamAPILogger.logError('GetPlayerSummaries', error, { steamidsCount: steamids.length });
            throw error;
        }
    ...
    static async getFriendsStatuses(friend_ids, auth, avatarsCache = {}) {
        ...
        try {
            ...
            SteamAPILogger.logError('getFriendsStatuses', error, { friendsCount: friend_ids.length });
            throw error;
        }
    }
